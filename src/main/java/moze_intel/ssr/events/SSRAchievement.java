...
public class SSRAchievement {
	...
	public static void Get() {
		 ...
		 * "tier2Shard", 4, 0, ObjHandler.SOUL_SHARD,
		 * achievementTier1).registerStat();
		 * 
		 * achievementTier3 = new Achievement("achievement.tier3Shard",
		 * "tier3Shard", 6, 0, ObjHandler.SOUL_SHARD,
		 * achievementTier2).registerStat();
		 * 
		 * achievementTier4 = new Achievement("achievement.tier4Shard",
		 * "tier4Shard", 8, 0, ObjHandler.SOUL_SHARD,
		 * achievementTier3).registerStat();
		 * 
		 * achievementTier5 = new Achievement("achievement.tier5Shard",
		 * "tier5Shard", 10, 0, ObjHandler.SOUL_SHARD,
		 * achievementTier4).registerStat();
		 */
