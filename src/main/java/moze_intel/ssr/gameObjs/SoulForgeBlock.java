...
public class SoulForgeBlock extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        {
            SoulForgeTile tileentitySoulForge = (SoulForgeTile)world.getTileEntity(x, y, z);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack)
    {
        ...
        {
            ((SoulForgeTile)world.getTileEntity(x, y, z)).func_145951_a(itemStack.getDisplayName());
        }
    }
