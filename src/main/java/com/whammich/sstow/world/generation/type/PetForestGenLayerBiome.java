...
public class PetForestGenLayerBiome extends GenLayer {
	@SuppressWarnings("unchecked")
	private List<BiomeEntry>[] biomes = new ArrayList[BiomeManager.BiomeType
			.values().length];

	public PetForestGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_,
		...
		if (p_i2122_4_ == WorldType.DEFAULT_1_1) {
			...
			biomes[desertIdx].add(new BiomeEntry(Register.biomePetrifiedForest, 10));
			} else {
	...
	public int[] getInts(int p_75904_1_, int p_75904_2_, int p_75904_3_,
		...
		for (int i1 = 0; i1 < p_75904_4_; ++i1) {
			for (int j1 = 0; j1 < p_75904_3_; ++j1) {
				this.initChunkSeed((long) (j1 + p_75904_1_),
						(long) (i1 + p_75904_2_));
