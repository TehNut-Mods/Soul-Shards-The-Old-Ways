...
public class ModelSoulAnvil extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(this.ShardPT3.offsetX, this.ShardPT3.offsetY, this.ShardPT3.offsetZ);
        GL11.glTranslatef(this.ShardPT3.rotationPointX * f5, this.ShardPT3.rotationPointY * f5, this.ShardPT3.rotationPointZ * f5);
