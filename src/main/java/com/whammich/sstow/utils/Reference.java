...
public class Reference {
	...
	public static final String requiredDependencies = "required-after:Baubles@[1.0.1.10,);required-after:guideapi@[1.7.10-1.0-15,)";
	public static final String wailaCallBack = "com.whammich.sstow.compat.waila.WailaProvider.callbackRegister";
