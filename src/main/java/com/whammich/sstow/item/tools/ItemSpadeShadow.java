...
public class ItemSpadeShadow extends ItemSpade {

	
	public ItemSpadeShadow(ToolMaterial Material) {
		super(Material);
	...
	public String getUnlocalizedName(ItemStack stack) {
		return "item.sstow.shadowtool.spade";
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerIcons(IIconRegister iconRegister) {
		itemIcon = iconRegister.registerIcon(Reference.modID + ":spadeShadow");
	}
	
	static Material[] materials = new Material[] {
		Material.clay, Material.coral, Material.craftedSnow, Material.grass, Material.ground, Material.sand, Material.snow
	};
