...
import com.whammich.sstow.util.TextHelper;
        ...
        if ((params.length > 0) && (params.length <= 7)) {
            if (params[0].equalsIgnoreCase("killall")) {
                ...
                if (params.length == 2) {
                    ...
                    if (((EntityPlayerMP) sender).getHeldItem(EnumHand.MAIN_HAND) != null && ((EntityPlayerMP) sender).getHeldItem(EnumHand.MAIN_HAND).getItem() == ModObjects.shard) {
