...
public class ObjHandler
{
	...
	public static void init()
	{
		...
		GameRegistry.addShapedRecipe(new ItemStack(sCage, 1, 0), "aaa", "a a", "aaa", 'a', Blocks.iron_bars);
		if(SoulConfig.enableEndStoneRecipe)
			GameRegistry.addShapedRecipe(new ItemStack(Blocks.end_stone, 2), " a ", "bcb", " a ", 'a',
			Blocks.stone, 'b', new ItemStack(Blocks.sand, 1, 0), 'c', Items.ender_pearl);
